...
- `-f<flag>`
  ...
  Флаг `-fenglish-only` говорит, что в коде допускаются только русские ключевые
  слова.
...
С флагом `-fenglish-only` русские ключевые слова в коде не допускаются.
...
21. `Non-English keyword`

    Ключевое слово не на английском языке (с флагом `-fenglish-only`).
