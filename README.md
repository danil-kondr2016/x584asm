...
- `-f<flag>`
  ...
  Флаг `-fnegative-flags` говорит, что допустимо приписывать или опускать
  `!` в начале обозначений флагов.
...
> [!NOTE]
> Если указан флаг командной строки `-fnegative-flags`, можно опускать
> `!` в флагах !СДЛ1, !СДЛ2, !СДП1, !СДП2 и приписывать `!` ко всем
> остальным флагам.
