...
#define SUM2_VARREG_REG1(_b, _op) \
	...
	{ARG(ADD_REG)|ARG(ADD_##_b), VAR_R3, REG_R3, 0, 0, OP_ADD_SUB_NEG, CARRY_VALUE_0, (_op)|0003},\
	{ARG(ADD_REG)|ARG(ADD_##_b)|ARG(ADD_1), VAR_R3, REG_R3, 0, 0, OP_ADD_SUB_NEG, CARRY_VALUE_1, (_op)|0003},\
	\
	{ARG(ADD_REG)|ARG(ADD_##_b)|ARG(ADD_C), VAR_R4, REG_R4, 0, 0, OP_ADD_SUB_NEG, CARRY_INDEFINITE, (_op)|0004},\
	{ARG(ADD_REG)|ARG(ADD_##_b), VAR_R4, REG_R4, 0, 0, OP_ADD_SUB_NEG, CARRY_VALUE_0, (_op)|0004},\
	{ARG(ADD_REG)|ARG(ADD_##_b)|ARG(ADD_1), VAR_R4, REG_R4, 0, 0, OP_ADD_SUB_NEG, CARRY_VALUE_1, (_op)|0004},\
	\
	{ARG(ADD_REG)|ARG(ADD_##_b)|ARG(ADD_C), VAR_R5, REG_R5, 0, 0, OP_ADD_SUB_NEG, CARRY_INDEFINITE, (_op)|0005},\
	{ARG(ADD_REG)|ARG(ADD_##_b), VAR_R5, REG_R5, 0, 0, OP_ADD_SUB_NEG, CARRY_VALUE_0, (_op)|0005},\
	{ARG(ADD_REG)|ARG(ADD_##_b)|ARG(ADD_1), VAR_R5, REG_R5, 0, 0, OP_ADD_SUB_NEG, CARRY_VALUE_1, (_op)|0005},\
	\
	{ARG(ADD_REG)|ARG(ADD_##_b)|ARG(ADD_C), VAR_R6, REG_R6, 0, 0, OP_ADD_SUB_NEG, CARRY_INDEFINITE, (_op)|0006},\
	{ARG(ADD_REG)|ARG(ADD_##_b), VAR_R6, REG_R6, 0, 0, OP_ADD_SUB_NEG, CARRY_VALUE_0, (_op)|0006},\
	{ARG(ADD_REG)|ARG(ADD_##_b)|ARG(ADD_1), VAR_R6, REG_R6, 0, 0, OP_ADD_SUB_NEG, CARRY_VALUE_1, (_op)|0006},\
	\
...
#define SUM1_VARREG(_b, _op) \
	...
	{ARG(ADD_##_b), VAR_R0, 0, 0, 0, OP_ADD_SUB_NEG, CARRY_VALUE_0, (_op)|0000},\
	{ARG(ADD_##_b)|ARG(ADD_1), VAR_R0, 0, 0, 0, OP_ADD_SUB_NEG, CARRY_VALUE_1, (_op)|0000},\
	\
	{ARG(ADD_##_b)|ARG(ADD_C), VAR_R1, 0, 0, 0, OP_ADD_SUB_NEG, CARRY_INDEFINITE, (_op)|0001},\
	{ARG(ADD_##_b), VAR_R1, 0, 0, 0, OP_ADD_SUB_NEG, CARRY_VALUE_0, (_op)|0001},\
	{ARG(ADD_##_b)|ARG(ADD_1), VAR_R1, 0, 0, 0, OP_ADD_SUB_NEG, CARRY_VALUE_1, (_op)|0001},\
	\
	{ARG(ADD_##_b)|ARG(ADD_C), VAR_R2, 0, 0, 0, OP_ADD_SUB_NEG, CARRY_INDEFINITE, (_op)|0002},\
	{ARG(ADD_##_b), VAR_R2, 0, 0, 0, OP_ADD_SUB_NEG, CARRY_VALUE_0, (_op)|0002},\
	{ARG(ADD_##_b)|ARG(ADD_1), VAR_R2, 0, 0, 0, OP_ADD_SUB_NEG, CARRY_VALUE_1, (_op)|0002},\
	\
	{ARG(ADD_##_b)|ARG(ADD_C), VAR_R3, 0, 0, 0, OP_ADD_SUB_NEG, CARRY_INDEFINITE, (_op)|0003},\
	{ARG(ADD_##_b), VAR_R3, 0, 0, 0, OP_ADD_SUB_NEG, CARRY_VALUE_0, (_op)|0003},\
	{ARG(ADD_##_b)|ARG(ADD_1), VAR_R3, 0, 0, 0, OP_ADD_SUB_NEG, CARRY_VALUE_1, (_op)|0003},\
	\
	{ARG(ADD_##_b)|ARG(ADD_C), VAR_R4, 0, 0, 0, OP_ADD_SUB_NEG, CARRY_INDEFINITE, (_op)|0004},\
	{ARG(ADD_##_b), VAR_R4, 0, 0, 0, OP_ADD_SUB_NEG, CARRY_VALUE_0, (_op)|0004},\
	{ARG(ADD_##_b)|ARG(ADD_1), VAR_R4, 0, 0, 0, OP_ADD_SUB_NEG, CARRY_VALUE_1, (_op)|0004},\
	\
	{ARG(ADD_##_b)|ARG(ADD_C), VAR_R5, 0, 0, 0, OP_ADD_SUB_NEG, CARRY_INDEFINITE, (_op)|0005},\
	{ARG(ADD_##_b), VAR_R5, 0, 0, 0, OP_ADD_SUB_NEG, CARRY_VALUE_0, (_op)|0005},\
	{ARG(ADD_##_b)|ARG(ADD_1), VAR_R5, 0, 0, 0, OP_ADD_SUB_NEG, CARRY_VALUE_1, (_op)|0005},\
	\
